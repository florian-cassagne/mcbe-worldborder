...
execute @s[z=-32, dz=48, scores={WorldBorder=20}] ~ ~ ~ fill -32 0 ~0 -32 255 ~16 barrier 
execute @s[z=32, dz=-48, scores={WorldBorder=20}] ~ ~ ~ fill -32 0 ~0 -32 255 ~-16 barrier
execute @s[z=-32, dz=48, scores={WorldBorder=20}] ~ ~ ~ fill 32 0 ~0 32 255 ~16 barrier
execute @s[z=32, dz=-48, scores={WorldBorder=20}] ~ ~ ~ fill 32 0 ~0 32 255 ~-16 barrier

execute @s[x=-32, dx=48, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 -32 ~16 255 -32 barrier
execute @s[x=32, dx=-48, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 -32 ~-16 255 -32 barrier
execute @s[x=-32, dx=48, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 32 ~16 255 32 barrier
execute @s[x=32, dx=-48, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 32 ~-16 255 32 barrier

execute @s[z=-33, dz=50, scores={WorldBorder=20}] ~ ~ ~ fill -33 0 ~0 -33 255 ~16 stained_glass 8
execute @s[z=33, dz=-50, scores={WorldBorder=20}] ~ ~ ~ fill -33 0 ~0 -33 255 ~-16 stained_glass 8
execute @s[z=-33, dz=50, scores={WorldBorder=20}] ~ ~ ~ fill 33 0 ~0 33 255 ~16 stained_glass 8
execute @s[z=33, dz=-50, scores={WorldBorder=20}] ~ ~ ~ fill 33 0 ~0 33 255 ~-16 stained_glass 8

execute @s[x=-33, dx=50, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 -33 ~16 255 -33 stained_glass 8
execute @s[x=33, dx=-50, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 -33 ~-16 255 -33 stained_glass 8
execute @s[x=-33, dx=50, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 33 ~16 255 33 stained_glass 8
execute @s[x=33, dx=-50, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 33 ~-16 255 33 stained_glass 8