...
execute @s[z=-256, dz=496, scores={WorldBorder=20}] ~ ~ ~ fill -256 0 ~0 -256 255 ~16 barrier
execute @s[z=256, dz=-496, scores={WorldBorder=20}] ~ ~ ~ fill -256 0 ~0 -256 255 ~-16 barrier
execute @s[z=-256, dz=496, scores={WorldBorder=20}] ~ ~ ~ fill 256 0 ~0 256 255 ~16 barrier
execute @s[z=256, dz=-496, scores={WorldBorder=20}] ~ ~ ~ fill 256 0 ~0 256 255 ~-16 barrier

execute @s[x=-256, dx=496, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 -256 ~16 255 -256 barrier
execute @s[x=256, dx=-496, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 -256 ~-16 255 -256 barrier
execute @s[x=-256, dx=496, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 256 ~16 255 256 barrier
execute @s[x=256, dx=-496, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 256 ~-16 255 256 barrier

execute @s[z=-257, dz=498, scores={WorldBorder=20}] ~ ~ ~ fill -257 0 ~0 -257 255 ~16 stained_glass 8
execute @s[z=257, dz=-498, scores={WorldBorder=20}] ~ ~ ~ fill -257 0 ~0 -257 255 ~-16 stained_glass 8
execute @s[z=-257, dz=498, scores={WorldBorder=20}] ~ ~ ~ fill 257 0 ~0 257 255 ~16 stained_glass 8
execute @s[z=257, dz=-498, scores={WorldBorder=20}] ~ ~ ~ fill 257 0 ~0 257 255 ~-16 stained_glass 8

execute @s[x=-257, dx=498, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 -257 ~16 255 -257 stained_glass 8
execute @s[x=257, dx=-498, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 -257 ~-16 255 -257 stained_glass 8
execute @s[x=-257, dx=498, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 257 ~16 255 257 stained_glass 8
execute @s[x=257, dx=-498, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 257 ~-16 255 257 stained_glass 8