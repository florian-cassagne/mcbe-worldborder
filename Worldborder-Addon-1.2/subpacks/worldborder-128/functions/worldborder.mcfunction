...
execute @s[z=-64, dz=112, scores={WorldBorder=20}] ~ ~ ~ fill -64 0 ~0 -64 255 ~16 barrier
execute @s[z=64, dz=-112, scores={WorldBorder=20}] ~ ~ ~ fill -64 0 ~0 -64 255 ~-16 barrier
execute @s[z=-64, dz=112, scores={WorldBorder=20}] ~ ~ ~ fill 64 0 ~0 64 255 ~16 barrier
execute @s[z=64, dz=-112, scores={WorldBorder=20}] ~ ~ ~ fill 64 0 ~0 64 255 ~-16 barrier

execute @s[x=-64, dx=112, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 -64 ~16 255 -64 barrier
execute @s[x=64, dx=-112, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 -64 ~-16 255 -64 barrier
execute @s[x=-64, dx=112, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 64 ~16 255 64 barrier
execute @s[x=64, dx=-112, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 64 ~-16 255 64 barrier

execute @s[z=-65, dz=114, scores={WorldBorder=20}] ~ ~ ~ fill -65 0 ~0 -65 255 ~16 stained_glass 8
execute @s[z=65, dz=-114, scores={WorldBorder=20}] ~ ~ ~ fill -65 0 ~0 -65 255 ~-16 stained_glass 8
execute @s[z=-65, dz=114, scores={WorldBorder=20}] ~ ~ ~ fill 65 0 ~0 65 255 ~16 stained_glass 8
execute @s[z=65, dz=-114, scores={WorldBorder=20}] ~ ~ ~ fill 65 0 ~0 65 255 ~-16 stained_glass 8

execute @s[x=-65, dx=114, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 -65 ~16 255 -65 stained_glass 8
execute @s[x=65, dx=-114, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 -65 ~-16 255 -65 stained_glass 8
execute @s[x=-65, dx=114, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 65 ~16 255 65 stained_glass 8
execute @s[x=65, dx=-114, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 65 ~-16 255 65 stained_glass 8