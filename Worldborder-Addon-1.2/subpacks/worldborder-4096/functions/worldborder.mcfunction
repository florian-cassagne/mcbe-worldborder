...
execute @s[z=-2048, dz=4080, scores={WorldBorder=20}] ~ ~ ~ fill -2048 0 ~0 -2048 255 ~16 barrier
execute @s[z=2048, dz=-4080, scores={WorldBorder=20}] ~ ~ ~ fill -2048 0 ~0 -2048 255 ~-16 barrier
execute @s[z=-2048, dz=4080, scores={WorldBorder=20}] ~ ~ ~ fill 2048 0 ~0 2048 255 ~16 barrier
execute @s[z=2048, dz=-4080, scores={WorldBorder=20}] ~ ~ ~ fill 2048 0 ~0 2048 255 ~-16 barrier

execute @s[x=-2048, dx=4080, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 -2048 ~16 255 -2048 barrier
execute @s[x=2048, dx=-4080, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 -2048 ~-16 255 -2048 barrier
execute @s[x=-2048, dx=4080, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 2048 ~16 255 2048 barrier
execute @s[x=2048, dx=-4080, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 2048 ~-16 255 2048 barrier

execute @s[z=-2049, dz=4082, scores={WorldBorder=20}] ~ ~ ~ fill -2049 0 ~0 -2049 255 ~16 stained_glass 8
execute @s[z=2049, dz=-4082, scores={WorldBorder=20}] ~ ~ ~ fill -2049 0 ~0 -2049 255 ~-16 stained_glass 8
execute @s[z=-2049, dz=4082, scores={WorldBorder=20}] ~ ~ ~ fill 2049 0 ~0 2049 255 ~16 stained_glass 8
execute @s[z=2049, dz=-4082, scores={WorldBorder=20}] ~ ~ ~ fill 2049 0 ~0 2049 255 ~-16 stained_glass 8

execute @s[x=-2049, dx=4082, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 -2049 ~16 255 -2049 stained_glass 8
execute @s[x=2049, dx=-4082, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 -2049 ~-16 255 -2049 stained_glass 8
execute @s[x=-2049, dx=4082, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 2049 ~16 255 2049 stained_glass 8
execute @s[x=2049, dx=-4082, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 2049 ~-16 255 2049 stained_glass 8