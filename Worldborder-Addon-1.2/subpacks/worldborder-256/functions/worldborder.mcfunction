...
execute @s[z=-128, dz=240, scores={WorldBorder=20}] ~ ~ ~ fill -128 0 ~0 -128 255 ~16 barrier
execute @s[z=128, dz=-240, scores={WorldBorder=20}] ~ ~ ~ fill -128 0 ~0 -128 255 ~-16 barrier
execute @s[z=-128, dz=240, scores={WorldBorder=20}] ~ ~ ~ fill 128 0 ~0 128 255 ~16 barrier
execute @s[z=128, dz=-240, scores={WorldBorder=20}] ~ ~ ~ fill 128 0 ~0 128 255 ~-16 barrier

execute @s[x=-128, dx=240, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 -128 ~16 255 -128 barrier
execute @s[x=128, dx=-240, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 -128 ~-16 255 -128 barrier
execute @s[x=-128, dx=240, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 128 ~16 255 128 barrier
execute @s[x=128, dx=-240, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 128 ~-16 255 128 barrier

execute @s[z=-129, dz=242, scores={WorldBorder=20}] ~ ~ ~ fill -129 0 ~0 -129 255 ~16 stained_glass 8
execute @s[z=129, dz=-242, scores={WorldBorder=20}] ~ ~ ~ fill -129 0 ~0 -129 255 ~-16 stained_glass 8
execute @s[z=-129, dz=242, scores={WorldBorder=20}] ~ ~ ~ fill 129 0 ~0 129 255 ~16 stained_glass 8
execute @s[z=129, dz=-242, scores={WorldBorder=20}] ~ ~ ~ fill 129 0 ~0 129 255 ~-16 stained_glass 8

execute @s[x=-129, dx=242, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 -129 ~16 255 -129 stained_glass 8
execute @s[x=129, dx=-242, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 -129 ~-16 255 -129 stained_glass 8
execute @s[x=-129, dx=242, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 129 ~16 255 129 stained_glass 8
execute @s[x=129, dx=-242, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 129 ~-16 255 129 stained_glass 8