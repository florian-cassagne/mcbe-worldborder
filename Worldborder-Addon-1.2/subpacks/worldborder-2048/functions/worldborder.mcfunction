...
execute @s[z=-1024, dz=2032, scores={WorldBorder=20}] ~ ~ ~ fill -1024 0 ~0 -1024 255 ~16 barrier
execute @s[z=1024, dz=-2032, scores={WorldBorder=20}] ~ ~ ~ fill -1024 0 ~0 -1024 255 ~-16 barrier
execute @s[z=-1024, dz=2032, scores={WorldBorder=20}] ~ ~ ~ fill 1024 0 ~0 1024 255 ~16 barrier
execute @s[z=1024, dz=-2032, scores={WorldBorder=20}] ~ ~ ~ fill 1024 0 ~0 1024 255 ~-16 barrier

execute @s[x=-1024, dx=2032, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 -1024 ~16 255 -1024 barrier
execute @s[x=1024, dx=-2032, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 -1024 ~-16 255 -1024 barrier
execute @s[x=-1024, dx=2032, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 1024 ~16 255 1024 barrier
execute @s[x=1024, dx=-2032, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 1024 ~-16 255 1024 barrier

execute @s[z=-1025, dz=2034, scores={WorldBorder=20}] ~ ~ ~ fill -1025 0 ~0 -1025 255 ~16 stained_glass 8
execute @s[z=1025, dz=-2034, scores={WorldBorder=20}] ~ ~ ~ fill -1025 0 ~0 -1025 255 ~-16 stained_glass 8
execute @s[z=-1025, dz=2034, scores={WorldBorder=20}] ~ ~ ~ fill 1025 0 ~0 1025 255 ~16 stained_glass 8
execute @s[z=1025, dz=-2034, scores={WorldBorder=20}] ~ ~ ~ fill 1025 0 ~0 1025 255 ~-16 stained_glass 8

execute @s[x=-1025, dx=2034, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 -1025 ~16 255 -1025 stained_glass 8
execute @s[x=1025, dx=-2034, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 -1025 ~-16 255 -1025 stained_glass 8
execute @s[x=-1025, dx=2034, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 1025 ~16 255 1025 stained_glass 8
execute @s[x=1025, dx=-2034, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 1025 ~-16 255 1025 stained_glass 8