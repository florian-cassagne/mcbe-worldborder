...
execute @s[z=-512, dz=1008, scores={WorldBorder=20}] ~ ~ ~ fill -512 0 ~0 -512 255 ~16 barrier
execute @s[z=512, dz=-1008, scores={WorldBorder=20}] ~ ~ ~ fill -512 0 ~0 -512 255 ~-16 barrier
execute @s[z=-512, dz=1008, scores={WorldBorder=20}] ~ ~ ~ fill 512 0 ~0 512 255 ~16 barrier
execute @s[z=512, dz=-1008, scores={WorldBorder=20}] ~ ~ ~ fill 512 0 ~0 512 255 ~-16 barrier

execute @s[x=-512, dx=1008, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 -512 ~16 255 -512 barrier
execute @s[x=512, dx=-1008, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 -512 ~-16 255 -512 barrier
execute @s[x=-512, dx=1008, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 512 ~16 255 512 barrier
execute @s[x=512, dx=-1008, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 512 ~-16 255 512 barrier

execute @s[z=-513, dz=1010, scores={WorldBorder=20}] ~ ~ ~ fill -513 0 ~0 -513 255 ~16 stained_glass 8
execute @s[z=513, dz=-1010, scores={WorldBorder=20}] ~ ~ ~ fill -513 0 ~0 -513 255 ~-16 stained_glass 8
execute @s[z=-513, dz=1010, scores={WorldBorder=20}] ~ ~ ~ fill 513 0 ~0 513 255 ~16 stained_glass 8
execute @s[z=513, dz=-1010, scores={WorldBorder=20}] ~ ~ ~ fill 513 0 ~0 513 255 ~-16 stained_glass 8

execute @s[x=-513, dx=1010, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 -513 ~16 255 -513 stained_glass 8
execute @s[x=513, dx=-1010, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 -513 ~-16 255 -513 stained_glass 8
execute @s[x=-513, dx=1010, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 513 ~16 255 513 stained_glass 8
execute @s[x=513, dx=-1010, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 513 ~-16 255 513 stained_glass 8