...
execute @s[z=-5000, dz=9984, scores={WorldBorder=20}] ~ ~ ~ fill -5000 0 ~0 -5000 255 ~16 barrier
execute @s[z=5000, dz=-9984, scores={WorldBorder=20}] ~ ~ ~ fill -5000 0 ~0 -5000 255 ~-16 barrier
execute @s[z=-5000, dz=9984, scores={WorldBorder=20}] ~ ~ ~ fill 5000 0 ~0 5000 255 ~16 barrier
execute @s[z=5000, dz=-9984, scores={WorldBorder=20}] ~ ~ ~ fill 5000 0 ~0 5000 255 ~-16 barrier

execute @s[x=-5000, dx=9984, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 -5000 ~16 255 -5000 barrier
execute @s[x=5000, dx=-9984, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 -5000 ~-16 255 -5000 barrier
execute @s[x=-5000, dx=9984, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 5000 ~16 255 5000 barrier
execute @s[x=5000, dx=-9984, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 5000 ~-16 255 5000 barrier

execute @s[z=-5001, dz=9986, scores={WorldBorder=20}] ~ ~ ~ fill -5001 0 ~0 -5001 255 ~16 stained_glass 8
execute @s[z=5001, dz=-9986, scores={WorldBorder=20}] ~ ~ ~ fill -5001 0 ~0 -5001 255 ~-16 stained_glass 8
execute @s[z=-5001, dz=9986, scores={WorldBorder=20}] ~ ~ ~ fill 5001 0 ~0 5001 255 ~16 stained_glass 8
execute @s[z=5001, dz=-9986, scores={WorldBorder=20}] ~ ~ ~ fill 5001 0 ~0 5001 255 ~-16 stained_glass 8

execute @s[x=-5001, dx=9986, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 -5001 ~16 255 -5001 stained_glass 8
execute @s[x=5001, dx=-9986, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 -5001 ~-16 255 -5001 stained_glass 8
execute @s[x=-5001, dx=9986, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 5001 ~16 255 5001 stained_glass 8
execute @s[x=5001, dx=-9986, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 5001 ~-16 255 5001 stained_glass 8