...
execute @s[z=-10000, dz=19984, scores={WorldBorder=20}] ~ ~ ~ fill -10000 0 ~0 -10000 255 ~16 barrier
execute @s[z=10000, dz=-19984, scores={WorldBorder=20}] ~ ~ ~ fill -10000 0 ~0 -10000 255 ~-16 barrier
execute @s[z=-10000, dz=19984, scores={WorldBorder=20}] ~ ~ ~ fill 10000 0 ~0 10000 255 ~16 barrier
execute @s[z=10000, dz=-19984, scores={WorldBorder=20}] ~ ~ ~ fill 10000 0 ~0 10000 255 ~-16 barrier

execute @s[x=-10000, dx=19984, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 -10000 ~16 255 -10000 barrier
execute @s[x=10000, dx=-19984, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 -10000 ~-16 255 -10000 barrier
execute @s[x=-10000, dx=19984, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 10000 ~16 255 10000 barrier
execute @s[x=10000, dx=-19984, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 10000 ~-16 255 10000 barrier

execute @s[z=-10001, dz=19986, scores={WorldBorder=20}] ~ ~ ~ fill -10001 0 ~0 -10001 255 ~16 stained_glass 8
execute @s[z=10001, dz=-19986, scores={WorldBorder=20}] ~ ~ ~ fill -10001 0 ~0 -10001 255 ~-16 stained_glass 8
execute @s[z=-10001, dz=19986, scores={WorldBorder=20}] ~ ~ ~ fill 10001 0 ~0 10001 255 ~16 stained_glass 8
execute @s[z=10001, dz=-19986, scores={WorldBorder=20}] ~ ~ ~ fill 10001 0 ~0 10001 255 ~-16 stained_glass 8

execute @s[x=-10001, dx=19986, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 -10001 ~16 255 -10001 stained_glass 8
execute @s[x=10001, dx=-19986, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 -10001 ~-16 255 -10001 stained_glass 8
execute @s[x=-10001, dx=19986, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 10001 ~16 255 10001 stained_glass 8
execute @s[x=10001, dx=-19986, scores={WorldBorder=20}] ~ ~ ~ fill ~0 0 10001 ~-16 255 10001 stained_glass 8